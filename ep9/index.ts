const dbdlgames = [-
    ...
    const cheapest = game.filter(function(element, index) {
    ...
    function A(person.firstName + " " + person.lastName)
    ...
    const football = {
        ...
        likeTeam: function(){
            return this.league.standings.filter(function(element, index) {
                return element.team.name === 'Totnamhot Sper'
            })
        },
        goodFailPoint: function(){
            return this.league.standings.filter(function(element, index) {
                return element.team.name === 'Totnamhot Sper'
            })[0].goalsDiff
        },
        lowerFourty: function(){
            return this.league.standings.filter(function(element, index) {
